  ...
  Locations: [
    {
      ...
      Neighbors: [["UpstairsDekuTree", "exit"]]
    },
    {
      ShortName: "DownstairsDekuTree",
      Name: "Deku Tree Basement",
      ShortText:
        "You fall down to below where the spider web was (this is all you can do for now)",
    ...
    },
    {
      ...
      LongText:
        "Looking down you can see an area below the spider webs on the first floor, you also see a room to the side",
      Neighbors: [
        ["InsideDekuTree", "down"],
        ["SlingshotRoom", "side", "room", "slingshot"]
      ],
      Actions: [
        {
          ...
          RequiresOn: [
            [
              "hasSlingshot",
              "You probably shouldn't jump down until you get the slingshot"
            ]
          ],
          ResultsOn: ["Web Broken"],
          ShortText:
            "You jump down and break the web on the floor below and fall through to the basement",
    ...
    },
    {
      ...
      ShortText:
        "You enter the Great Deku Tree, you hear monsters above and below you",
      LongText: "You can go up or down",
      Neighbors: [
        ["DekuTree", "outside"],
        ["UpstairsDekuTree", "up", "upstairs", "second floor"]
      ],
      Actions: [
        {
          Nicknames: ["Climb"],
    ...
    },
    {
      ...
      RequiresOn: [
        [
          "hasShield",
          "Milo won't let you enter without a sheild, maybe you can find one for sale nearby"
        ],
        [
          "hasSword",
          "Milo won't let you enter without a Sword. Maybe you can find one around here?"
        ]
      ],
      Neighbors: [
    ...
    },
    {
      ...
      Name: "Kokori Tunnel",
      ShortText:
        "You crawl through a small tunnel and make it to a hidden area.",
    ...
    },
    {
      ...
      LongText:
        "Kokori Forest is populated with the Kokori people. There are several homes and a Shop.  You notice a small tunnel.  There is a path to Hyrule Field, another leads to the Great Deku Tree, and another towards the Forest Temple",
      Neighbors: [
        ["KokoriShop", "shop", "store"],
        ["DekuTree", "tree", "deku"],
        ["Tunnel", "tunnel", "sword"]
      ],
      Items: [
